  ...
  <a-row class="header_bar">
    ...
    <a-col :xl="23" :lg="22" :md="21" :sm="21">
      <a-row type="flex" justify="end">
        ...
        <a-col :xl="1" :lg="3" :md="4" :sm="4">
          <a-dropdown v-model="visible" overlay-class-name="theme-config">
            <div class="menu-icon">
              <span>
                <a-icon type="setting" class="menu-icon-item"/>
              </span>
            </div>
            <div slot="overlay">
              <div class="w_theme_select">
                ...
                <div class="w_theme_content">
                  <div v-for="color in colors" :key="color" class="w_theme_color_block" :style="[{'background':color}]" @click="changeTheme(color)">
                    <a-icon v-if="activeTheme===color" type="check"/>
                  </div>
                </div>
                <h3 class="w_theme_select_title">
                  菜单颜色
                ...
                <div>
                  <a-switch checked-children="深色" un-checked-children="浅色" default-checked @change="changeMenuTheme"/>
                </div>
              </div>
            </div>
          </a-dropdown>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                colors: ['#F5222D', '#FF8000', '#FAAD14', '#13C2C2', '#52C41A', '#1890FF', '#2F54E8', '#722ED1'],
                themeTigger: true,
                activeTheme: '#FF8000',
                visible: false,
                env: env
            ...
            dropClick({ key }) {
                switch (key) {
                    ...
                    case 'logout':
                        ...
                        this.$router.push(this.env.VUE_APP_LOGIN)
